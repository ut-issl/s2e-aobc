 ...
 * @brief Components installed on a spacecraft
 */
class AocsModuleComponents : public s2e::spacecraft::InstalledComponents {
 public:
  /**
   ...
   */
  void LogSetup(s2e::logger::Logger &logger) override;

 private:
  // CDH
  s2e::components::ObcWithC2a *aobc_;  //!< Attitude On Board Computer
  // Power
  ...
  // Mission
  s2e::components::Telescope *telescope_;  //!< Telescope
  // HILS
  s2e::simulation::HilsPortManager *hils_port_manager_;
