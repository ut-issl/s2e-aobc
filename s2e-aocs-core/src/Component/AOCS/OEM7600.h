...
private:
  ...
  std::vector<unsigned char> ConvertDoubleToByte(const double double_data);            // convert position,velocity data in double format into byte format
  std::vector<unsigned char> ConvertFloatToByte(const float float_data);               // convert position,velocity data in float format into byte format
