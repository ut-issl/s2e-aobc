...
INA260::INA260(
    ...
    OnBoardComputer *obc) : Component(prescaler, clock_gen, ina_power_port),
...
void INA260::GenerateTelemetry()
{
  ...
  // WriteRegister((unsigned char)INA260_REGISTER::VOLTAGE, voltage_tlm_mV, kTlmSize); //TODO　現在のI2C Portの仕様では、1レジスタが8byte以上のパターンに対応できない
