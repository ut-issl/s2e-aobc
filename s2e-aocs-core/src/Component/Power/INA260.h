...
/* References
Manual: https://www.tij.co.jp/jp/lit/ds/symlink/ina260.pdf?ts=1624796495336&ref_url=https%253A%252F%252Fwww.google.com%252F
HowToUse: NA
Note: Functions not used in the project are not implemented
*/

class INA260 : public ComponentBase, public ObcI2cTargetCommunicationBase
{
public:
  INA260(
    int prescaler,
    ClockGenerator* clock_gen, 
    PowerPort* ina_power_port,                  // Power port witch provides electrical power to INA260
