...
PowerController::PowerController(
    PCU pcu,
    const std::vector<int> gpio_ports,
    const std::vector<double> output_voltage_list,
    OBC* obc
  ):PCU(pcu),
    ObcGpioBase(gpio_ports, obc),
    output_voltage_list_(output_voltage_list)
{
